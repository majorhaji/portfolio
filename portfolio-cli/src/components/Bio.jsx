  ...
  return (
    <div className="bio">
      <section className="about-me">
        ...
        <p>
          I'm a huge football fan and supporter of Manchester United, go reds!{" "}
        </p>

        <p>
          I do a lot of work with Revive Family & Youth Services, an
          organisation that seeks to provide support to the local community.
          Check them out <a href="https://revivefys.org/">here</a>{" "}
        </p>
      </section>
    </div>
  );
